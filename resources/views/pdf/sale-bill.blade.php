       ...
       <tbody>
           <tr>
               <td style="border-width: 0;">
                   <p style="font-size: 3rem;">Estimate</p>
                   <p class="mb-4">
               ...
               <td class="text-right" style="border-width: 0;">
                    {{-- <img src="{{ url('assets/img/bmc.png') }}" alt="BMC" width="80"> --}}
               </td>
           </tr>
       </tbody>
    </table>
    ...
    <table class="table table-bordered  mb-4" style="min-width: 30rem">
        ...
        <tbody>
            ...
            @php  
                ...
                $totalqty += abs((float)$transaction->quantity);  
            @endphp
            <tr>
                <td>{{ $loop->iteration }}</td>
                <td>{{ @$transaction->item->name }}</td>
                <td>{{ @$transaction->rate ? abs((float)$transaction->rate) :'' }}</td>
                <td>{{ @$transaction->quantity ? abs((float)$transaction->quantity) :'' }}</td>
