...
<section class="table-responsive rounded mb-2">
    <table class="table table-bordered align-middle" style="min-width: 60rem;">
        ...
        <tbody>
            ...
            if( ($prev_transaction_num_last != $transaction->transaction->transaction_number && $k > 0)){
                $is_change = true;
            }else{ 
           ...
           // } 
            ...
            @php $prev_transaction_num_last =$transaction->transaction->transaction_number; 
             @endphp
            @endforeach
        </tbody>
    </table>
        ...
        <form action="{{ route('sendmessage',['order'=>$order]) }}" method="POST">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    @csrf
                    <input type="hidden" class="transaction_id" name="transaction_id" required>
